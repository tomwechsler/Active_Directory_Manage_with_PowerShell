...
New-ADOrganizationalUnit -Path "OU=Luzern,DC=corp,DC=pri" -Name "Engineers"
...
#Identify the OUs
Get-ADOrganizationalUnit -Identity "OU=Engineers,OU=Luzern,DC=corp,DC=pri"
Get-ADOrganizationalUnit -Identity "OU=Engineers,DC=corp,DC=pri"
...
Remove-ADOrganizationalUnit "OU=Engineers,DC=corp,DC=pri" 

#With which account am I logged in?
whoami

#Let's take a close look at the OU
Get-ADOrganizationalUnit "OU=Engineers,DC=corp,DC=pri" -Properties *

#We set the value to False
Set-ADOrganizationalUnit -ProtectedFromAccidentalDeletion $false -Identity "OU=Engineers,DC=corp,DC=pri"
